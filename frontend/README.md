...
The [d3-cloud](https://github.com/jasondavies/d3-cloud) library is used to generate the visualizations. To modify the rendered image, edit the following lines of code.
```javascript
var layout = cloud()
  .size([300,300])
  .words(
